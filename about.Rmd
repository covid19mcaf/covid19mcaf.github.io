...
##### El enfoque de análisis que utilizaremos el estudio de Box y Jenkin modelos conocidos como ARIMA (p,d,q): Autoregresivos, Integrados y de Medias móviles.
##### Utilizaremos en R-studio la función auto.arima, la cual nos devuelve el modelo que minimiza el criterio de información de Akaike y el criterio de información Bayesiando. Este paso nos ahorra realizar a partir de los datos distintos procesos para convertir nuestra serie en estacionaria.
