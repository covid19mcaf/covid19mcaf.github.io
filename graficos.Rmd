...
plot(exp(casos_nacional_1304[]),xlim=c(0,80),ylim=c(0,200000),ylab="Nº casos", xlab="Días", main="Predicciones casos")
lines(exp(pronostico_casos_1304$mean), col= "green")
points(exp(pronostico_casos_1304$mean), col= "green")
